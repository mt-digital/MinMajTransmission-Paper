...
{\centering \includegraphics[width=0.8\textwidth,height=\textheight]{Figures/ReserveMap.pdf}
...
\caption{We can model the relevant groups for mixing as either village
...
{\centering \includegraphics[width=0.95\textwidth,height=\textheight]{Figures/ResultsSketch.pdf}
