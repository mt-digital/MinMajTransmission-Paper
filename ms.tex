...
\author[a,1]{Matthew A. Turner}
\author[b]{Laís Albuquerque de Oliveira}
\author[c]{Izabela Maurício de Rezende}
\author[d,e]{Adam Z. Reynolds}
\author[a]{James Holland Jones}
\author[b]{Simone Simionatto}

{\small
\affil[a]{Department of Environmental Social Sciences, Stanford Doerr School of Sustainability, Yang \& Yamazaki Energy and Environment Building, 473 Via Ortega, Room 140, Stanford, CA 94305-4216}
\affil[b]{Health Sciences Research Laboratory, Federal University of Grande Dourados, Dourados, Mato Grosso do Sul,
Brazil}
\affil[c]{Stanford Pandemic Preparedness Hub, Department of Medicine, Division of Infectious
Diseases and Geographic Medicine, Stanford University School of Medicine, Stanford, CA, United States}
\affil[d]{Department of Anthropology, University of New Mexico}
\affil[e]{Department of Internal Medicine, University of New Mexico}
\affil[1]{Correspondence: \href{maturner@stanford.edu}{maturner@stanford.edu}}
\date{\today}
}
...
Indigenous peoples and other minoritized groups suffered more during the COVID-19
pandemic than their non-Indigenous peers.
In this work we analyze an empirically-motivated compartmental model of COVID-19 
outbreaks in the Dourados Indigenous
Reserve in Greater Dourados, Mato Grosso do Sul, Brazil, to develop strategies
designed to reduce the burden of future pandemics in the Reserve. The interventions we suggest and analyze would provide
economic relief to keep Indigenous peoples living on the Reserve from traveling
the city of Dourados, where they are hypothesized to have first contracted
different COVID-19 variants, which they subsequently transmitted within the reserve. 
Models such as this are essential
since it is impossible to perform experiments of different intervention strategies
for pandemic preparedness---if they were possible, they would be unethical.
This modeling work can be used by decision makers and stakeholders to prepare
ready-made interventions to be deployed when the next pandemic inevitably
emerges and spreads quickly as SARS-CoV-2 did. This strategy could
improve outcomes in similar situations where Indigenous peoples on 
reserves (or reservations in the U.S.) travel to more densely populated areas
to work or for other reasons.
\end{abstract}
...
one of two ethnicities, Guarani and Terena~\mt{need to address complexity of ethnicities,
how there are many ethnicities within the ``Guarani'' umbrella term, for example.}. 
...
There may be other social factors that may be necessary for the time series
observations of De Oliveira and colleagues. 
...
We hypothesize that even if mobility was reduced identically across ethnicities and 
villages the effect would be different for different groups. For instance, 
we may find that Guarani benefit the most from an intervention compared to 
Terena, or compared to relative reduction within villages.
